...
#각 지점의 지사들은 자신 지역 매장의 total quantity를 가지고 있어야 한다.
...
g1 = GwangjuOffice()
g1.setName("광주 1호점")
g1.setQuantity(500000)

g2 = GwangjuOffice()
g2.setName("광주 2호점")
g2.setQuantity(400000)
